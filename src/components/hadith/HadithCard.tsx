...
export const HadithCard: React.FC<HadithCardProps> = ({
  ...
  return (
    <div className="rounded-3xl p-5 bg-white dark:bg-[#1A221C] border border-[#E8EFEA] dark:border-[#3A4D43]/60 shadow-xs space-y-4 transition-colors">
      ...
      <div className="flex items-start justify-between gap-2 border-b border-[#E8EFEA] dark:border-[#3A4D43]/40 pb-3">
        <div className="space-y-1">
          <div className="flex flex-wrap items-center gap-1.5">
            <span className="text-xs font-bold text-[#176B4D] dark:text-[#9DD6B9] bg-[#D4F2E2]/60 dark:bg-[#005236]/40 px-2.5 py-0.5 rounded-full">
          ...
          <p className="text-xs font-semibold text-[#414A45] dark:text-[#C1CAC4]">
            {hadith.narratorBengali}
          </p>
        </div>
      ...
      {/* Arabic Script */}
      <div className="p-4 rounded-2xl bg-[#F4F8F5] dark:bg-[#1E2821] border border-[#176B4D]/15 dark:border-[#9DD6B9]/15 text-right space-y-2">
        <div
          dir="rtl"
          className="text-lg sm:text-xl font-serif text-[#176B4D] dark:text-[#9DD6B9] font-normal leading-loose"
      ...
      <div className="flex items-center justify-between pt-2 border-t border-[#E8EFEA] dark:border-[#3A4D43]/40 text-xs">
        ...
        {hadith.explanationBengali && (
          <button
            ...
            className="flex items-center gap-1 font-semibold text-[#176B4D] dark:text-[#9DD6B9] hover:underline"
          >
      ...
      {showExplanation && hadith.explanationBengali && (
        <div className="p-4 rounded-2xl bg-[#E8EFEA]/80 dark:bg-[#222C25] border border-[#176B4D]/20 text-xs text-[#181D19] dark:text-[#E1E5E1] leading-relaxed space-y-1 animate-in fade-in">
          <div className="font-bold text-[#176B4D] dark:text-[#9DD6B9] flex items-center gap-1.5 mb-1">
            <BookOpen className="w-3.5 h-3.5" />
